...
// "Custom" has no fixed catalogue image — it's a CTA into the custom-poster service.
export const categoryShowcase = [
    { category: 'Autosport', image: carAmgGt },
    { category: 'Anime', image: animeOnepieceJollyroger },
    { category: 'Sports', image: sportsMessi },
    { category: 'TV Series', image: movieGodzilla },
    { category: 'Music', image: musicTheWeeknd },
    { category: 'Video-Games', image: gamingCodZombies },
    { category: 'Motivate', image: motivationalEverythingOk },
...
export const formatProductName = (product) => `${product.name} (${product.subCategory})`
